...
public class AddEmployeeSteps extends CommonMethods {
	...
	//Extra practice: create another scenario where you send the username and password as parameters 
	...
	//table.asList()	 - a complete list including the header, would be messy to tell where one employee starts and where it ends 
